...
public class UserDAO implements IUserDAO {
    ...
    public void insertUser(User user) throws SQLException {
        ...
        try (Connection connection = getConnection(); PreparedStatement preparedStatement = connection.prepareStatement("insert into users (name,email,country,type_id) value (?,?,?,?);")) {
    ...
    public List<User> selectAllUsers() {
        ...
        try (Connection connection = getConnection();
             ...
             // Step 2:Create a statement using connection object
             PreparedStatement preparedStatement = connection.prepareStatement("select * from users s join type t on s.type_id = t.id;");) {
            System.out.println(preparedStatement);
            // Step 3: Execute the query or update query
            ResultSet rs = preparedStatement.executeQuery();
            ...
            while (rs.next()) {
                ...
                TypeUser typeUser = typeService.selectUser(typeId);
                user = new User(id, name, email, country);
    ...
    public boolean updateUser(User user) throws SQLException {
        ...
        try (Connection connection = getConnection(); PreparedStatement statement = connection.prepareStatement(UPDATE_USERS_SQL);) {
            ...
            statement.setInt(4,user.getTypeUser().getId());
    ...
    public void insertUserStore(User user) throws SQLException {
        ...
        try {
            ...
            callableStatement.setInt(4, user.getTypeUser().getId());
